...
<p>开发环境没有这个 API，我做了一层封装来模拟行为，保证开发环境和生产环境的代码编写是一样的，效果也是一样的，直接使用即可。</p>
<p>同时，无论选择 React 还是 Vue，写法都一样。</p>
<p>使用例子：</p>
<div class="language-jsx line-numbers-mode" data-highlighter="prismjs" data-ext="jsx"><pre v-pre><code><span class="line"><span class="token keyword">import</span> getLangMsg <span class="token keyword">from</span> <span class="token string">"@utils/langMsg"</span><span class="token punctuation">;</span></span>
<span class="line"></span>
<span class="line"><span class="token comment">// 例子获取一个词条</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>国际化文本维护在 <code v-pre>src/lang</code> 文件夹中。正常情况下至少要在本地提供一个中文词条和英文字条的 JSON 文件。一般发布的时候，会有对应的流水根据中文词条去把其他语言的词条生成出来。</p>
