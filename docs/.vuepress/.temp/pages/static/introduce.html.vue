...
<span class="line">        <span class="token literal-property property">text</span><span class="token operator">:</span> <span class="token string">"这是一个示例"</span><span class="token punctuation">,</span></span>
...
<span class="line">        model<span class="token punctuation">.</span>dom<span class="token punctuation">.</span>innerHTML <span class="token operator">=</span> result<span class="token punctuation">;</span> <span class="token comment">// 挂载</span></span>
<span class="line">      <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line">    <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line">  <span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span>
<span class="line">  <span class="token comment">// KDApi注册一个id号，这个id号要和控件方案的id号对应</span></span>
<span class="line">  KDApi<span class="token punctuation">.</span><span class="token function">register</span><span class="token punctuation">(</span><span class="token string">"demo"</span><span class="token punctuation">,</span> demo<span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">(</span>window<span class="token punctuation">.</span>KDApi<span class="token punctuation">)</span><span class="token punctuation">;</span></span>
...
<li>
<p>除了 <code v-pre>index.js</code> 入口资源外，其他资源需要通过 <code v-pre>KDApi</code> 的 API 去拉取。</p>
</li>
</ul>
...
<p>所以工程采用的是 JS 动态拉取策略去加载资源，例如 Vue3 工程里的 <code v-pre>index.ts</code> 可以简单这样做：</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>主要是通过 <code v-pre>import(&quot;&quot;).then</code> 配合 Webpack 代码分割 + css 独立文件打包，可以让打包后的 js 文件自动拉取 css 文件。那么就不用关系资源引用问题了。</p>
<blockquote>
<p><strong>Webpack 的 optimization 配置影响很大，大家切记不要动这块配置。</strong></p>
</blockquote>
<p><strong>不过，这样会引申出另外一个问题：代码共用！</strong></p>
...
<p>例如一个叫 Demo 的控件，在 A 页面需要显示，首先会拉取资源执行。然后 B 页面也需要显示，它就不会再拉取资源了，直接用之前拉取过的资源。</p>
<p>这会带来全局变量污染的问题。</p>
<p>例如有个 <code v-pre>tool.ts</code> 文件，里面声明了一个变量 <code v-pre>name</code> ，A 页面的控件 Demo 修改了这个变量为 <code v-pre>'A'</code>，此时 B 页面的控件 Demo 修改了这个变量为 <code v-pre>'B'</code>，那么 A 页面的的控件 Demo 再去读取 <code v-pre>name</code> 的时候，读取到的就是 <code v-pre>'B'</code>。</p>
<p><strong>基于这个问题影响最大的是单例模式的 store 如何隔离的问题。</strong></p>
<blockquote>
<p>普通变量的隔离方案还在摸索中~</p>
</blockquote>
...
<li>
<p>在组件内声明的变量也是独立的（当然不要在组件的定义外去声明）。</p>
</li>
</ul>
