...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>此时你会看到根目录出现了一个新的文件夹叫 <code v-pre>cache</code> ，里面的文件是从 Webpack 在开发模式中把打包到内存中的二进制文件转化后复制到这里的。</p>
<p>如何预览？</p>
<p>首先我在苍穹的开发平台上把自己的自定义控件注册上，例如我的React起步工程例子（这块自定义控件注册金蝶苍穹社区上有其他人的文档教学，我这里就不多说了 <a href="https://vip.kingdee.com/article/150626162270913792?productLineId=29&amp;lang=zh-CN" target="_blank" rel="noopener noreferrer">自定义控件系列（持续更新）</a>）：</p>
<p><img src="@source/dev/images/1.png" alt="例子"></p>
<p>保存后退出！从这里“眼睛”预览按钮点进去预览：</p>
...
<p>注意！如果后端环境更新了，需要重新从“眼睛”预览按钮那里重新打开页面，不然页面链接到的后端资源还是旧的。</p>
